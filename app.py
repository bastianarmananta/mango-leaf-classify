...
DROPBOX_TOKEN = 'sl.BiM4Dugnr__qafLlRw8-GK3fQhJVog2EMeJOG-5VPtaSQ38_leiz6yaYlwAJ2A78_uIXT9sGcfoezBPewSaOUF90qY6tguNoQ4mibnFOfKiAWmD2ktmtsSq-PzmtyUrqgAp2AY0'
...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.caption('Result of this project is model can classify image into 5 class Antrachnose, Bacterial Canker, Die Back, Healthy and Powdery Mildew with 91% test accuracy.')
